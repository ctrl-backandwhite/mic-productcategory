...
public class ProductSearchUseCaseImpl implements ProductSearchUseCase {
        ...
        public ProductSearchResponse search(
                ...
                SearchPage<ProductDocument> searchPage = productSearchRepository.search(
                                query, categoryIds, brand, minPrice, maxPrice, inStock, sortBy, pageable);
                ...
                for (SearchHit<ProductDocument> hit : searchPage.getSearchHits()) {
                        ...
                        hits.add(ProductSearchResponse.ProductSearchHit.builder()
                                        .id(doc.getId())
                                        .pid(doc.getPid())
                                        .name(doc.getName())
                ...
                return ProductSearchResponse.builder()
                                .results(hits)
                                .totalHits(searchPage.getSearchHits().getTotalHits())
                                .page(page)
                                .size(size)
                                .build();
        }
        ...
        public List<AutocompleteSuggestion> autocomplete(String query, int limit) {
                ...
                return productSearchRepository.autocomplete(query, limit).stream()
