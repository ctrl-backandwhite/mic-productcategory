...
public interface CategoryUseCase {
         ...
         *
         * @param rows each row contains translations for level 1, optionally 2 and 3
        ...
        record BulkCategoryRow(
                        List<CategoryTranslation> level1Translations,
                        List<CategoryTranslation> level2Translations,
