...
public class CjInventorySyncScheduler {
    ...
    /**
     * Runs every 4 hours to refresh variant inventory levels from CJ. Cron: 0 0
     * *\/4 * * * — at minute 0 of every 4th hour.
     */
    ...
    public void syncInventory() {
        ...
        try {
            ...
            log.info("Scheduled inventory sync finished: total={}, synced={}, failed={}", result.getTotalItems(),
